...
Only approximately half of articles modelled occupancy dynamics for a single species. Others fit multiple occupancy models: either multi-species models where 2+ species were modelled in concert, or many independent models for a suite of species. The largest number of species modelled in a single paper was **`{r} max(species_Number$Taxa_Number)`**.
