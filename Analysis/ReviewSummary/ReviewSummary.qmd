...
The most frequent category of authorship was academic, with `{r} max(authorCategories_overall)`% of articles having at least one author from an academic institution.
