...
# Write to disk
write_csv(outputList, file = "Randomisation/FirstSampleRanks.csv")
```
...
wosQuery <- readxl::read_xls("Queries/MacKenzie WOS/MacKenzie03.xls") %>%
...
write_csv(randomisedWOS, "Randomisation/SecondSampleRanks.csv")
...
A basic representation of the two sample's coverage is presented here.
