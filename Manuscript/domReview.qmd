...
Ecologists have long sought to understand the processes by which species are distributed across landscapes and throughout time \[@humboldt1849\]. Research on these patterns of occurrence is valuable in many ways — simply describing where a species occurs may be of use in monitoring programs, and identifying the drivers of distribution can help to determine how best to manage or conserve a species.

In recent decades, interest in distributions has precipitated numerous methods for quantitatively modelling species distributions \[@elith2009\]. In their typical form species distribution models (SDMs) correlate species occurrence records with environmental covariates to describe where species occur on the landscape. They have been implemented in several thousand scientific articles and are frequently relied upon to support management and conservation programs. Despite their popularity SDMs do have considerable downsides. Typically, they do not explicitly account for imperfect detection, where a species is present at a site but is not detected. Imperfect detection is known to lead to biased estimates of occupancy and is a ubiquitous and near-unavoidable feature of wildlife presence-absence data. SDMs also tend to be most effective when species are at equilibrium states, and can struggle to predict to novel environments or future conditions.

Another approach to modelling species occurrence is the occupancy model, first introduced in @mackenzie2002. Like SDMs, occupancy models estimate probabilities of species occurrence; unlike SDMs, occupancy models account for imperfect detection by explicitly modelling the process of detection. @mackenzie2003 extends the original occupancy model to describe change in species occurrence across multiple time-steps. Despite the similarity in their output, SDMs and occupancy models have developed largely distinctly.
