...
plot_reviewCoverage <- 
  ...
  scale_fill_manual("",
                    ...
                    values = c("#4D7668", "gray50")) +
  scale_y_continuous(expand = c(0,0), limits = c(0, 65)) +
  scale_x_continuous(#limits = seq(2004, 2023, 1),
                     breaks = seq(2004, 2023, 4),
                     labels = seq(2004, 2023, 4)) +
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        axis.text.y = element_text(size = 10, family = "helvetica", colour = "#585858"),
        axis.text.x = element_text(size = 10, family = "helvetica", 
                                   colour = "#585858", angle = 60,
                                   vjust = 1, hjust = 1), 
        axis.title = element_text(size = 10, family = "helvetica", colour = "#585858"), 
        legend.text = element_text(size = 10, family = "helvetica", colour = "#585858"),
        strip.text.x = element_text(size = 10, family = "helvetica", colour = "#585858"))
plot_reviewCoverage
ggsave(plot = plot_reviewCoverage, "Figures/1_CoveragePlot.png",
       width = 945, height = 700, units = "px")
```
...
ggsave("Figures/3a_StudyMap.eps", plot = plot_studyAreaMap,
...
plot_studyAreaSize <- sheet_StudyArea |>
  ...
  theme(panel.grid = element_blank(),
        axis.text.x = element_markdown(size = 8, angle = 90,
                                       vjust = 0.5, hjust = 1,
                                       family = "Helvetica", colour = "#585858"),
        axis.text.y = element_blank(), axis.ticks.y = element_blank(),
        panel.background = element_rect(fill='transparent', color=NA),
        plot.background = element_rect(fill='transparent', color=NA))
plot_studyAreaSize

ggsave("Figures/3b_StudyArea.eps",
...
ggsave("Figures/3c_Taxa.eps",
       plot_focalTaxa, width = 95, height = 40, units = "mm",
       bg = "transparent")
```
...
ggsave(plot = plot_studyDuration, 
       filename = "Figures/3e_Duration.eps",
       height = 35, width = 110, units = "mm",
       bg = "transparent")

# Calculate sample size
stat_studyDuration <- sheet_DataCollection |>
  filter(`Start month` != "Unclear" & `End month` != "Unclear") |>
  nrow()
stat_studyDuration
```
...
```{r Primary occasions}
stat_medianPrimary <- sheet_DataCollection |>
  pull(`Primary occasions`) |>
  median()
stat_medianPrimary

stat_primaryRange <- sheet_DataCollection |>
  pull(`Primary occasions`) |>
  range()
stat_primaryRange
```
...
plot_covariateQuantity <- sheet_Covariates |> 
  ...
  mutate(`Parameter type` = case_when(`Parameter type` == "Extinction_Persistence" ~ "Extinction",
                                      ...
                                      `Parameter type` == "Initial occupancy" ~ "Initial\noccupancy",
  ...
  theme(legend.position = "top",
        ...
        legend.key.size = unit(12.5, 'points'),
        axis.text.x = element_blank(), axis.ticks.x = element_blank(),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(), 
        panel.grid.minor.y = element_blank(),
        #panel.background = element_rect(fill = "gray80"),
        strip.text = element_text(size = 10, family = "Helvetica", colour = "#585858"), 
        axis.title.y = element_text(size = 10, family = "Helvetica", colour = "#585858"), 
        axis.text = element_text(size = 10, family = "Helvetica", colour = "#585858"),
        legend.text = element_text(size = 10, family = "Helvetica", colour = "#585858"))

plot_covariateQuantity
ggsave(plot = plot_covariateQuantity, filename = "Figures/5_CovariateCount.png",
...
write_csv(table_covariateSummary, "Figures/S1_CovariateTable.csv")
```
...
write_csv(modelling_summary, "Figures/T2_ModellingSummary.csv")
```
...
covariateFreq <- sheet_Covariates |>
  ...
  mutate(Category = case_when(Category == "ANY" ~ "Any",
                              ...
                              Category == "S" ~ "Structural")) |>
  mutate(Cat_Included = paste0(Category, Included)) |>
  
  ggplot(aes(y = Covariate, x = PctCategory, fill = Cat_Included)) +
  geom_col(colour = "white", 
           linewidth = 1, width = 1) +
  scale_fill_manual(limits = c("AnyTRUE", "EnvironmentalTRUE", "StructuralTRUE",
                               "AnyFALSE", "EnvironmentalFALSE", "StructuralFALSE"), 
                    values = c("goldenrod", "#4D7668", "plum4",
                               "gray80", "gray80", "gray80")) +
  scale_x_continuous(expand = c(0,0), breaks = c(25,50,75)) +
  facet_grid(rows = vars(Category), 
             scales = "free_y", space = "free_y", switch = "y") +
  labs(x = "", y = "", title = "Percent of\nmodels considering:") +
  theme(legend.position = "none",
        plot.background = element_blank(),
        panel.grid = element_blank(),
        axis.text.y = element_text(family = "Helvetica"),
                                   #angle = 90, vjust = 0.5, hjust = 1),
        strip.text.y = element_text(family = "Helvetica"),
...
covariateDyn <- sheet_Covariates |>
  ...
  mutate(Category = case_when(Category == "ANY" ~ "Any",
                              Category == "E" ~ "Environmental",
                              Category == "S" ~ "Structural")) |>
  mutate(Cat_Dyn = paste0(Category, Dyn)) |>
  
  ggplot(aes(y = Covariate, x = PctDyn, fill = Cat_Dyn)) +
  geom_col(colour = "white", 
           linewidth = 1, width = 1) +
  scale_fill_manual(limits = c("AnyTRUE", "EnvironmentalTRUE", "StructuralTRUE",
                               "AnyFALSE", "EnvironmentalFALSE", "StructuralFALSE"), 
...
covariateObs <- sheet_Covariates |>
  ...
  mutate(Category = case_when(Category == "ANY" ~ "Any",
                              Category == "E" ~ "Environmental",
                              Category == "S" ~ "Structural")) |>
  mutate(Cat_Obs = paste0(Category, Obs)) |>
  
  ggplot(aes(y = Covariate, x = PctObs, fill = Cat_Obs)) +
  geom_col(colour = "white", 
           linewidth = 1, width = 1) +
  scale_fill_manual(limits = c("AnyTRUE", "EnvironmentalTRUE", "StructuralTRUE",
                               "AnyFALSE", "EnvironmentalFALSE", "StructuralFALSE"), 
...
covariateComplex <- sheet_Covariates |>
  ...
  mutate(Category = case_when(Category == "ANY" ~ "Any",
                              Category == "E" ~ "Environmental",
                              Category == "S" ~ "Structural")) |>
  mutate(Cat_Complex = paste0(Category, Complex)) |>
  
  ggplot(aes(y = Covariate, x = PctComplex, fill = Cat_Complex)) +
  geom_col(colour = "white", 
           linewidth = 1, width = 1) +
  scale_fill_manual(limits = c("AnyTRUE", "EnvironmentalTRUE", "StructuralTRUE",
                               "AnyFALSE", "EnvironmentalFALSE", "StructuralFALSE"), 
...
covariatePatchwork <- covariateFreq + covariateDyn + covariateObs + covariateComplex +
  ...
  theme(axis.text = element_text(size = 8, family = "Helvetica", colour = "#585858",
                                 face = "italic"),
        axis.title = element_text(size = 8, family = "Helvetica", colour = "#585858"),
        plot.title = element_text(size = 8, family = "Helvetica", 
                                  colour = "#585858", hjust = 0.5),
        plot.tag = element_text(size = 9, family = "Helvetica", colour = "#585858")) 
covariatePatchwork

#ggsave(plot = covariatePatchwork, "Figures/4_CovariateSummary.png",
#       width = 1961, height = 1600, units = "px")
```
...
plot_objectiveTrend <- sheet_Objectives |>
  ...
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank(),
        legend.text = element_text(size = 9, family = "helvetica", colour = "#585858"),
        axis.text = element_text(size = 9, family = "helvetica", colour = "#585858"), 
        axis.title = element_text(size = 9, family = "helvetica", colour = "#585858"),
        legend.box.margin = margin(-5,-10,-10,-10),
        legend.key.size = unit(12.5, 'points'),
        legend.position = "top", 
        strip.background = element_blank(),
...
plot_objectiveTrend
ggsave(plot = plot_objectiveTrend, "Figures/2_Objectives.png",
       width = 1476, height = 700, units = "px")
```
...
timeSeries_Sites <- sheet_DataCollection |>
  ...
  geom_boxplot(fill = "#4D7668", 
               linewidth = .3, staplewidth = 0.33,
               colour = "gray25") +
  scale_y_log10(breaks = c(10,100,1000,10000), limits = c(10,10000)) +
...
timeSeries_Covariates <- sheet_Covariates |>
  ...
  geom_boxplot(fill = "#4D7668", linewidth = .3, staplewidth = 0.33,
               colour = "gray25") +
  scale_y_log10() +
  labs(x = "", y = "Covariates per\nparameter (log)",
       title = "") +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(), 
        axis.title = element_text(size = 8, family = "Helvetica"), 
...
timeSeries_Combined <- timeSeries_Sites + timeSeries_Covariates + timeSeries_Framework + timeSeries_Selection + free(timeSeries_Validation, "space", "l") +
  plot_layout(design = "1122
                        3344
                        #55#") +
  plot_annotation(tag_levels = list(c("(a) Number of sites",
                                      "(b) Number of covariates considered",
                                      "(c) Modelling framework",
                                      "(d) Covariate selection method (MLE*)",
                                      "(e) Model assessment"))) &
  theme(legend.position = "top",
        panel.grid.minor.y = element_blank(),
        axis.text.x = element_text(size = 10, family = "Helvetica", colour = "#585858",
                                 angle = 45, vjust = 1, hjust = 1),
        axis.text.y = element_text(size = 10, family = "Helvetica", colour = "#585858"),
        axis.title = element_text(size = 10, family = "Helvetica", colour = "#585858"),
        legend.text = element_text(size = 10, family = "Helvetica", colour = "#585858"),
        legend.title = element_text(size = 10, family = "Helvetica", colour = "#585858"),
        legend.key.size = unit(.2, 'cm'),
        legend.margin=margin(0,0,0,0),
        legend.box.margin=margin(0,-10,-5,-10),
        plot.tag = element_text(size = 10, family = "Helvetica", colour = "#585858"),
        plot.tag.location = "plot",
        plot.title = element_text(size = 10, family = "Helvetica", colour = "#585858",
                                  hjust = 0.5))
timeSeries_Combined

ggsave(plot = timeSeries_Combined, "Figures/6_TimeSeries.png",
       width = 1961, height = 2200, units = "px")
```
