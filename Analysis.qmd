...
plot_reviewCoverage <- 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        axis.text.y = element_text(size = 8, family = "helvetica", colour = "#585858"),
        ...
        strip.text.x = element_text(size = 8, family = "helvetica", colour = "#585858"))
#+ facet_grid(cols = vars(Strata), scales = "free_x", switch = "x")
plot_reviewCoverage
ggsave(plot = plot_reviewCoverage, "Figures/CoveragePlot.png",
...
plot_covariateQuantity <- sheet_Covariates |> 
  ...
  theme(legend.position = "top",
        ...
        strip.text = element_text(size = 7.5, family = "Helvetica", colour = "#585858"), 
        axis.title.y = element_text(size = 8, family = "Helvetica", colour = "#585858"), 
        axis.text = element_text(size = 8, family = "Helvetica", colour = "#585858"),
        legend.text = element_text(size = 8, family = "Helvetica", colour = "#585858"))

plot_covariateQuantity
ggsave(plot = plot_covariateQuantity, filename = "Figures/CovParamPlot.png",
...
covariateComplex <- sheet_Covariates |>
  ...
  facet_grid(rows = vars(Category), scales = "free_y",
             space = "free_y", switch = "y") +
  labs(x = "", y = "", title = "Average rate non-linear\nor interactive:") +
  theme(legend.position = "none",
        plot.background = element_blank(),
        panel.grid = element_blank(),
        axis.text.y = element_text(family = "Helvetica"), 
